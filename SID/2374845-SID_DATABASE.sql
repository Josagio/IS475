...
VALUES
    ('123456789', 'Machine Learning in Finance', 'Research Assistant'),
    ('1122334469', 'Data Analysis in Healthcare', 'Teaching Assistant'),
    ('1122334470', 'Artificial Intelligence in Business', 'Research Assistant'),
    ('1122334472', 'Cybersecurity in IoT', 'Teaching Assistant'),
    ('1122334474', 'Blockchain Applications', 'Research Assistant'),
    ('1122334476', 'Environmental Sustainability', 'Teaching Assistant'),
    ('2233445570', 'Human-Computer Interaction', 'Research Assistant'),
    ('2233445571', 'Big Data Analytics', 'Teaching Assistant'),
    ('2233445573', 'Software Engineering Practices', 'Research Assistant'),
    ('2233445575', 'Quantum Computing', 'Teaching Assistant'),
    ('2233445577', 'Neural Networks in Robotics', 'Research Assistant'),
    ('2233578896', 'Renewable Energy Technologies', 'Teaching Assistant'),
    ('2345678901', 'Genomic Data Analysis', 'Research Assistant'),
    ('3334445556', 'Mobile App Development', 'Teaching Assistant'),
    ('3344556673', 'Augmented Reality Applications', 'Research Assistant'),
    ('3344556674', 'E-commerce Security', 'Teaching Assistant'),
    ('3344556676', 'Digital Marketing Strategies', 'Research Assistant'),
    ('3344556677', 'Cloud Computing in Business', 'Teaching Assistant'),
    ('3344556678', 'Social Media Analytics', 'Research Assistant'),
    ('3344556680', 'Health Informatics', 'Teaching Assistant'),
    ('4455667784', 'Biochemical Engineering', 'Research Assistant'),
    ('4455667785', 'Renewable Energy Policy', 'Teaching Assistant'),
    ('4455667787', 'Data Privacy in Online Services', 'Research Assistant'),
    ('4455667788', 'Human Rights and Technology', 'Teaching Assistant'),
    ('4455667789', 'Autonomous Vehicles', 'Research Assistant'),
    ('4455667791', 'Cryptography and Network Security', 'Teaching Assistant'),
    ('5520778895', 'Natural Language Processing', 'Research Assistant'),
    ('5544332211', 'Climate Change Modeling', 'Teaching Assistant'),
    ('5566768899', 'Geospatial Data Analysis', 'Research Assistant'),
    ('5566778885', 'Biomedical Imaging', 'Teaching Assistant'),
    ('5566778886', 'Financial Fraud Detection', 'Research Assistant'),
    ('5566778887', 'Human-Centered Design', 'Teaching Assistant'),
    ('5566778888', 'Internet of Things Applications', 'Research Assistant'),
    ('5566778889', 'Supply Chain Optimization', 'Teaching Assistant'),
    ('5566778890', 'Educational Technology', 'Research Assistant'),
    ('5566778891', 'Smart Cities Development', 'Teaching Assistant'),
    ('5566778892', 'Virtual Reality in Education', 'Research Assistant'),
    ('5566778893', 'Social Impact of Technology', 'Teaching Assistant'),
    ('5566778894', 'Robotics in Healthcare', 'Research Assistant'),
    ('5566778895', 'Game Development', 'Teaching Assistant'),
    ('5566778896', 'Ethical Hacking', 'Research Assistant'),
    ('5566778898', 'Supply Chain Analytics', 'Teaching Assistant'),
    ('5566778899', 'Biological Data Mining', 'Research Assistant'),
    ('5569018892', 'Precision Agriculture Technologies', 'Teaching Assistant'),
    ('5588008890', 'Smart Home Systems', 'Research Assistant'),
    ('5678991234', 'Machine Vision', 'Teaching Assistant'),
    ('6543210987', 'Digital Forensics', 'Research Assistant'),
    ('6677889900', 'Autonomous Drones', 'Teaching Assistant'),
    ('6677889906', 'Quantum Cryptography', 'Research Assistant'),
    ('6677889907', 'Urban Planning with GIS', 'Teaching Assistant'),
    ('6677889909', 'Blockchain in Supply Chain', 'Research Assistant'),
    ('6677889911', 'Healthcare Informatics', 'Teaching Assistant'),
    ('6677889914', 'Data Ethics', 'Research Assistant'),
    ('7788990011', 'Epidemiological Modeling', 'Teaching Assistant'),
    ('7788990017', 'Natural Resource Management', 'Research Assistant'),
    ('7788990018', 'Human-Computer Interaction in Education', 'Teaching Assistant'),
    ('7788990020', 'Graph Theory in Network Security', 'Research Assistant'),
    ('7788990022', 'Information Retrieval Systems', 'Teaching Assistant'),
    ('7788990025', 'Computational Biology', 'Research Assistant'),
    ('7890123456', 'Telemedicine Applications', 'Teaching Assistant'),
    ('8899001128', '3D Printing Technologies', 'Research Assistant'),
    ('8899001129', 'Biometric Authentication Systems', 'Teaching Assistant'),
    ('8899001131', 'Space Exploration Technologies', 'Research Assistant'),
    ('8899001133', 'Smart Agriculture', 'Teaching Assistant'),
    ('8899001136', 'Cyber-Physical Systems', 'Research Assistant'),
    ('9876543210', 'Digital Sociology', 'Teaching Assistant');
