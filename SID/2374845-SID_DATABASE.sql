...
VALUES
    ('1122334469', 'Exploring Trends in Healthcare Analytics', 'Research Assistant'),
    ('1122334470', 'Impact of Artificial Intelligence on Business Strategies', 'Teaching Assistant'),
    ('1122334472', 'Enhancing Cybersecurity Measures in IoT Environments', 'Research Assistant'),
    ('1122334474', 'Applications of Blockchain Technology in Finance', 'Teaching Assistant'),
    ('1122334476', 'Sustainable Practices for Environmental Conservation', 'Research Assistant'),
    ('2233445570', 'Human-Computer Interaction in Virtual Environments', 'Teaching Assistant'),
    ('2233445571', 'Big Data Analytics for Social Impact', 'Research Assistant'),
    ('2233445573', 'Advancements in Software Engineering Practices', 'Teaching Assistant'),
    ('2233445575', 'Quantum Computing for Secure Communications', 'Research Assistant'),
    ('2233445577', 'Neural Networks in Robotics: A Comprehensive Study', 'Teaching Assistant'),
    ('2233578896', 'Innovations in Renewable Energy Technologies', 'Research Assistant'),
    ('2345678901', 'Genomic Data Analysis for Precision Medicine', 'Teaching Assistant'),
    ('3334445556', 'Mobile App Development for Health and Wellness', 'Research Assistant'),
    ('3344556673', 'Augmented Reality Applications in Education', 'Teaching Assistant'),
    ('3344556674', 'E-commerce Security: Threats and Countermeasures', 'Research Assistant'),
    ('3344556676', 'Digital Marketing Strategies for Global Brands', 'Teaching Assistant'),
    ('3344556677', 'Cloud Computing in Business: Opportunities and Challenges', 'Research Assistant'),
    ('3344556678', 'Social Media Analytics for Audience Engagement', 'Teaching Assistant'),
    ('3344556680', 'Health Informatics: Transforming Healthcare Delivery', 'Research Assistant'),
    ('4455667784', 'Biochemical Engineering for Sustainable Bioproduction', 'Teaching Assistant'),
    ('4455667785', 'Renewable Energy Policy and its Impact on Society', 'Research Assistant'),
    ('4455667787', 'Ensuring Data Privacy in Online Services', 'Teaching Assistant'),
    ('4455667788', 'Human Rights and Technology: Ethical Considerations', 'Research Assistant'),
    ('4455667789', 'Autonomous Vehicles: Challenges and Future Prospects', 'Teaching Assistant'),
    ('4455667791', 'Cryptography and Network Security in Modern Communication', 'Research Assistant'),
    ('5520778895', 'Natural Language Processing: From Theory to Applications', 'Teaching Assistant'),
    ('5544332211', 'Climate Change Modeling for Environmental Predictions', 'Research Assistant'),
    ('5566768899', 'Geospatial Data Analysis for Urban Planning', 'Teaching Assistant'),
    ('5566778885', 'Biomedical Imaging Techniques and Applications', 'Research Assistant'),
    ('5566778886', 'Detecting Financial Fraud with Machine Learning', 'Teaching Assistant'),
    ('5566778887', 'Human-Centered Design in User Interface Development', 'Research Assistant'),
    ('5566778888', 'Internet of Things Applications in Smart Cities', 'Teaching Assistant'),
    ('5566778889', 'Optimizing Supply Chains with Advanced Analytics', 'Research Assistant'),
    ('5566778890', 'Educational Technology for 21st Century Learning', 'Teaching Assistant'),
    ('5566778891', 'Smart Cities Development: A Comprehensive Approach', 'Research Assistant'),
    ('5566778892', 'Virtual Reality in Education: Transforming Learning Experiences', 'Teaching Assistant'),
    ('5566778893', 'Social Impact of Technology: Challenges and Opportunities', 'Research Assistant'),
    ('5566778894', 'Robotics in Healthcare: Improving Patient Care', 'Teaching Assistant'),
    ('5566778895', 'Game Development: Creativity and Technology Integration', 'Research Assistant'),
    ('5566778896', 'Ethical Hacking: Ensuring Cybersecurity', 'Teaching Assistant'),
    ('5566778898', 'Supply Chain Analytics for Operational Excellence', 'Research Assistant'),
    ('5566778899', 'Biological Data Mining: Insights from Life Sciences Data', 'Teaching Assistant'),
    ('5569018892', 'Precision Agriculture Technologies for Sustainable Farming', 'Research Assistant'),
    ('5588008890', 'Smart Home Systems: Automation and Connectivity', 'Teaching Assistant'),
    ('5678991234', 'Machine Vision: Applications in Image Recognition', 'Research Assistant'),
    ('6543210987', 'Digital Forensics: Investigating Cybersecurity Incidents', 'Teaching Assistant'),
    ('6677889900', 'Autonomous Drones: Applications and Challenges', 'Research Assistant'),
    ('6677889906', 'Quantum Cryptography: Securing Communication Channels', 'Teaching Assistant'),
    ('6677889907', 'Urban Planning with GIS: Enhancing City Development', 'Research Assistant'),
    ('6677889909', 'Blockchain in Supply Chain: Transforming Logistics', 'Teaching Assistant'),
    ('6677889911', 'Healthcare Informatics: Improving Patient Outcomes', 'Research Assistant'),
    ('6677889914', 'Data Ethics: Considerations in Data-Driven Decision Making', 'Teaching Assistant'),
    ('7788990011', 'Epidemiological Modeling: Understanding Disease Spread', 'Research Assistant'),
    ('7788990017', 'Natural Resource Management: Sustainability Practices', 'Teaching Assistant'),
    ('7788990018', 'Human-Computer Interaction in Education: Pedagogical Insights', 'Research Assistant'),
    ('7788990020', 'Graph Theory in Network Security: Analyzing Connectivity', 'Teaching Assistant'),
    ('7788990022', 'Information Retrieval Systems: Enhancing Search Algorithms', 'Research Assistant'),
    ('7788990025', 'Computational Biology: Insights from Computational Approaches', 'Teaching Assistant'),
    ('7890123456', 'Telemedicine Applications: Transforming Healthcare Delivery', 'Research Assistant'),
    ('8899001128', '3D Printing Technologies: Innovations in Manufacturing', 'Teaching Assistant'),
    ('8899001129', 'Biometric Authentication Systems: Ensuring Security', 'Research Assistant'),
    ('8899001131', 'Space Exploration Technologies: Exploring the Cosmos', 'Teaching Assistant'),
    ('8899001133', 'Smart Agriculture: Improving Crop Yield and Efficiency', 'Research Assistant'),
    ('8899001136', 'Cyber-Physical Systems: Integrating Computing and Physical Processes', 'Teaching Assistant'),
    ('9876543210', 'Digital Sociology: Understanding the Impact of Technology on Society', 'Research Assistant');
